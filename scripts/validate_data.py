...
if __name__ == "__main__":
    ...
    original_data_path = os.path.join(base_path, '..', 'data', 'interim', 'cleaned_dataset.csv')
    processed_data_path = os.path.join(base_path, '..', 'data', 'processed', 'processed_dataset_with_features.csv')
