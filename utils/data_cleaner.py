...
# Testing the function (Uncomment to test)
if __name__ == "__main__":
    # Provide the correct path to your dataset file
    raw_data_path = '../data/raw/Dataset (ATS)-1.csv'  # Update this with the correct path
    ...
    # Returns: First few rows of the cleaned DataFrame for verification
